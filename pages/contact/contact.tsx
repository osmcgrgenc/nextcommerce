    ...
    return (
        <>
            <main className="main">
                ...
                <div className="container">
                    <div className="page-header page-header-big text-center p-0 relative">
                        <h1 className="page-title text-white absolute">Contact us<span
                            className="text-white">keep in touch with us</span></h1>
                        <img src="/assets/images/contact-header-bg.jpg" alt="Slide Image"
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6 mb-2 mb-lg-0">
                                ...
                                <p className="mb-3">Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu
                                        ...
                                        <div className="contact-info">
                                            ...
                                            <ul className="contact-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="https://portotheme.com/cdn-cgi/l/email-protection#694a"><span
                                                        className="__cf_email__"
                                                        data-cfemail="dbb2b5bdb49b96b4b7b7baf5b8b4b6">[email&#160;protected]</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
