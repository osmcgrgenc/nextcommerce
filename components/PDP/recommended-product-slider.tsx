...
function RecommendedProductSlider(props) {
    return (
        <>
            ...
            <div className="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                ...
                <div className="product product-7 text-center">
                    ...
                    <div className="product-body">
                        ...
                        <h3 className="product-title"><a href="product.html">Light brown studded Wide fit
                            wedges</a></h3>
                ...
                <div className="product product-7 text-center">
                    ...
                    <div className="product-body">
                        ...
                        <h3 className="product-title"><a href="product.html">Blue utility pinafore denim
                            dress</a></h3>
                        <div className="product-price">
                            $76.00
                        </div>
